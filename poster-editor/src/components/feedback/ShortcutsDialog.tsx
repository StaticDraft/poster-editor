...
const SHORTCUTS = [
  ...
  { key: 'Ctrl + G', desc: '一键将选中的多个图元编组 (Group)' },
  { key: 'Ctrl + Shift + G', desc: '解开选中的图元编组 (Ungroup)' },
  { key: 'Ctrl + L', desc: '快速锁定或解锁当前选中图元' },
  { key: 'Ctrl + [ / Ctrl + ]', desc: '下移一层 / 上移一层图元遮挡' },
  { key: 'Ctrl + Shift + [ / ]', desc: '置底 / 置顶图元遮挡层级' },
  { key: 'Shift + 点击', desc: '连续选择/多选多个图元组件' },
  { key: 'Ctrl + Z', desc: '撤销上一步操作' },
  { key: 'Ctrl + Y / Ctrl + Shift + Z', desc: '重做上一步撤销' },
  { key: 'Ctrl + C / Ctrl + V', desc: '复制 / 粘贴图元组件' },
  { key: 'Ctrl + S', desc: '快速保存海报工程' },
  { key: 'Delete / Backspace', desc: '物理删除当前选中的图元' },
